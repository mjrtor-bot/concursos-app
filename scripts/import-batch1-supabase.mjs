...
async function importBatch1() {
  console.log("=========================================================");
  console.log("   IMPORTAÇÃO DO LOTE 1 POLICIAL (500 QUESTÕES)         ");
  console.log("=========================================================");
  ...
  console.log("=========================================================");
  console.log(`[✓] QUESTÕES FINAL: ${finalQCount} (Esperado exato: 1760)`);
  console.log(`[✓] ALTERNATIVAS FINAL: ${finalACount} (Esperado exato: 7927)`);
  console.log("=========================================================");

  if (finalQCount !== 1760) {
    throw new Error(`Inconsistência no número de questões: esperado 1760, obtido ${finalQCount}`);
  }
  if (finalACount !== 7927) {
    throw new Error(`Inconsistência no número de alternativas: esperado 7927, obtido ${finalACount}`);
  }

  console.log(" IMPORTAÇÃO DO LOTE 1 CONCLUÍDA COM SUCESSO ABSOLUTO! ");
}

importBatch1().catch((err) => {
