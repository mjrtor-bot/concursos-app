...
async function importBatch3() {
  console.log("=========================================================");
  console.log("   IMPORTAÇÃO DO LOTE 3 POLICIAL (500 QUESTÕES)         ");
  console.log("=========================================================");
  ...
  const diffQ = finalQCount - initialQCount;
  const diffA = finalACount - initialACount;

  console.log("=========================================================");
  console.log(`[✓] QUESTÕES INICIAL: ${initialQCount} | FINAL: ${finalQCount} (+${diffQ})`);
  console.log(`[✓] ALTERNATIVAS INICIAL: ${initialACount} | FINAL: ${finalACount} (+${diffA})`);
  console.log("=========================================================");

  if (diffQ !== 500) {
    throw new Error(`Diferencial incorreto de questões: esperado +500, obtido +${diffQ}`);
  }

  console.log(" IMPORTAÇÃO DO LOTE 3 CONCLUÍDA COM SUCESSO ABSOLUTO! ");
}

importBatch3().catch((err) => {
  console.error("FALHA NA IMPORTAÇÃO DO LOTE 3:", err);
  process.exit(1);
});
