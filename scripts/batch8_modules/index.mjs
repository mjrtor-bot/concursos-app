...
export const TODAS_QUESTOES_LOTE8 = [
  ...penal01Questoes,
  ...penal02Questoes,
  ...penal03Questoes,
  ...procPenal01Questoes,
  ...
  ...transito01Questoes,
  ...transito02Questoes,
  ...dhCriminologia01Questoes,
  ...dhCriminologia02Questoes,
  ...port01Questoes,
  ...port02Questoes,
  ...rlmInfo01Questoes,
  ...rlmInfo02Questoes,
...
// UUID v5 namespace fixo para Lote 8
...
export function prepararParaBanco(q) {
  const questaoId = generateUuidV5(`q-pol-batch8-${q.idSlug}`);
  ...
  const alternativasRows = q.alternativas.map((alt, idx) => ({
    id: generateUuidV5(`alt-pol-batch8-${q.idSlug}-${idx}`),
