    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "Regra exata da tabela-verdade da conjunção (V ∧ V = V; nos demais casos é F)."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Incorreto. A conjunção exige a veracidade concomitante de todas as parcelas."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "Tabela-verdade da condicional: única linha falsa é antecedente V e consequente F."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Incorreto. P → Q é falsa unicamente quando P=V e Q=F."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        ...
        "texto": "Verdadeiro.",
        "correta": true,
        "explicacao_especifica": "P é V e ~Q é V. Na bicondicional, V ↔ V = V."
      },
      {
        "letra": "B",
        "texto": "Falso.",
        "correta": false,
        "explicacao_especifica": "Incorreto, pois ambos os lados têm o mesmo valor lógico (Verdadeiro)."
      },
      {
        "letra": "C",
        "texto": "Contradição pura indeterminável.",
        "correta": false,
        "explicacao_especifica": "A proposição possui valor lógico definido e determinável."
      },
      {
        "letra": "D",
        "texto": "Inconclusivo por falta de premissas.",
        "correta": false,
        "explicacao_especifica": "Os valores lógicos foram plenamente atribuídos."
      },
      {
        "letra": "E",
        "texto": "Falso contingencialmente.",
        "correta": false,
        "explicacao_especifica": "O resultado é verdadeiro."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        ...
        "texto": "Contradição.",
        "correta": false,
        "explicacao_especifica": "Contradição resulta sempre falsa em todas as linhas."
      },
      {
        "letra": "B",
        "texto": "Contingência.",
        "correta": false,
        "explicacao_especifica": "Contingência assume valores verdadeiros e falsos a depender das variáveis."
      },
      {
        "letra": "C",
        "texto": "Tautologia.",
        "correta": true,
        "explicacao_especifica": "Tautologia é a forma proposicional sempre verdadeira."
      },
      {
        "letra": "D",
        "texto": "Falácia formal simples.",
        "correta": false,
        "explicacao_especifica": "Falácia é um argumento inválido."
      },
      {
        "letra": "E",
        "texto": "Paradoxo lógico irresolúvel.",
        "correta": false,
        "explicacao_especifica": "Paradoxo é uma sentença que gera contradição lógica insolúvel."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "A negação de uma contradição é sempre uma tautologia."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Incorreto. ~(F) = V em todas as linhas, caracterizando tautologia."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "Aplicação direta da 1ª Lei de De Morgan: ~(P ∧ Q) ≡ ~P ∨ ~Q."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Incorreto. A regra de negação do conectivo 'e' é negar ambas e trocar por 'ou'."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "letra": "A",
        "texto": "Se o agente não investiga com rigor, então a quadrilha não é desarticulada.",
        "correta": false,
        "explicacao_especifica": "Inversa da condicional, não sua negação."
      },
      {
        "letra": "B",
        "texto": "O agente investiga com rigor e a quadrilha não é desarticulada.",
        "correta": true,
        "explicacao_especifica": "Regra da negação da condicional: ~(P → Q) ≡ P ∧ ~Q."
      },
      {
        "letra": "C",
        "texto": "Se a quadrilha foi desarticulada, então o agente investigou com rigor.",
        "correta": false,
        "explicacao_especifica": "Recíproca da condicional."
      },
      {
        "letra": "D",
        "texto": "O agente não investiga com rigor ou a quadrilha é desarticulada.",
        "correta": false,
        "explicacao_especifica": "Esta é uma equivalência de P → Q (~P ∨ Q), não a negação."
      },
      {
        "letra": "E",
        "texto": "A quadrilha não é desarticulada e o agente não investiga com rigor.",
        "correta": false,
        "explicacao_especifica": "Negação incorreta."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "letra": "A",
        "texto": "Se o juiz decreta a prisão preventiva, então há indícios suficientes de autoria.",
        "correta": false,
        "explicacao_especifica": "Recíproca (não equivalente)."
      },
      {
        "letra": "B",
        "texto": "Se o juiz não decreta a prisão preventiva, então não há indícios suficientes de autoria.",
        "correta": true,
        "explicacao_especifica": "Contrapositiva clássica: P → Q ≡ ~Q → ~P."
      },
      {
        "letra": "C",
        "texto": "Não há indícios suficientes de autoria e o juiz decreta a prisão preventiva.",
        "correta": false,
        "explicacao_especifica": "Proposição distinta."
      },
      {
        "letra": "D",
        "texto": "Se não há indícios suficientes de autoria, então o juiz não decreta a prisão preventiva.",
        "correta": false,
        "explicacao_especifica": "Inversa (não equivalente)."
      },
      {
        "letra": "E",
        "texto": "Há indícios suficientes de autoria ou o juiz não decreta a prisão preventiva.",
        "correta": false,
        "explicacao_especifica": "Forma incorreta."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": false,
        "explicacao_especifica": "Item incorreto. A negação de 'Todo' é 'Pelo menos um não', e não 'Nenhum'."
      },
      {
        "texto": "Errado",
        "correta": true,
        "explicacao_especifica": "Gabarito Errado. Negação de quantificador universal afirmativo (Todo) é o existencial negativo (Algum ... não)."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "letra": "A",
        "texto": "O réu não fugiu ou o comparsa não mentiu.",
        "correta": false,
        "explicacao_especifica": "Não trocou o conectivo por 'e'."
      },
      {
        "letra": "B",
        "texto": "O réu não fugiu e o comparsa não mentiu.",
        "correta": true,
        "explicacao_especifica": "De Morgan: nega ambas as sentenças e troca 'ou' por 'e'."
      },
      {
        "letra": "C",
        "texto": "Se o réu fugiu, o comparsa não mentiu.",
        "correta": false,
        "explicacao_especifica": "Formulação condicional inválida como negação."
      },
      {
        "letra": "D",
        "texto": "O réu fugiu e o comparsa mentiu.",
        "correta": false,
        "explicacao_especifica": "Apenas trocou 'ou' por 'e' sem negar as proposições."
      },
      {
        "letra": "E",
        "texto": "Ou o réu não fugiu ou o comparsa mentiu.",
        "correta": false,
        "explicacao_especifica": "Disjunção exclusiva indevida."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "C(8,3) = 56 equipes distintas, valor estritamente superior a 50."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Incorreto. O cálculo de C(8,3) resulta em 56 > 50."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        ...
        "texto": "15",
        "correta": false,
        "explicacao_especifica": "Combinação C(6,4)=15, mas em senhas a ordem importa."
      },
      {
        "letra": "B",
        "texto": "120",
      ...
      },
      {
        ...
        "texto": "360",
        "correta": true,
        "explicacao_especifica": "Arranjo A(6,4) = 6 × 5 × 4 × 3 = 360."
      },
      {
        "letra": "D",
        "texto": "720",
        "correta": false,
        "explicacao_especifica": "6! = 720 (permutação de 6 elementos)."
      },
      {
        "letra": "E",
        "texto": "1.296",
        "correta": false,
        "explicacao_especifica": "6^4 = 1.296 (caso com repetição permitida)."
      }
    ]
  },
  {
    ...
    "alternativas": [
      ...
      },
      {
        ...
        "texto": "120",
        "correta": true,
        "explicacao_especifica": "P(5) = 5! = 120 maneiras."
      },
      {
        "letra": "D",
        "texto": "240",
        "correta": false,
        "explicacao_especifica": "Cálculo superestimado."
      },
      {
        "letra": "E",
        "texto": "720",
        "correta": false,
        "explicacao_especifica": "6! = 720."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "C(4,2) × C(6,2) = 6 × 15 = 90 comissões."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Incorreto. O resultado exato do produto combinatório é 90."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "(4/10) × (3/9) = 12/90 = 2/15. Cálculo exato."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Incorreto. A probabilidade condicional sem reposição resulta precisamente em 2/15."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        ...
        "texto": "1/12",
        "correta": false,
        "explicacao_especifica": "3/36 = 1/12."
      },
      {
        "letra": "B",
        "texto": "1/6",
        "correta": true,
        "explicacao_especifica": "6 casos favoráveis em 36 = 6/36 = 1/6."
      },
      {
        "letra": "C",
        "texto": "7/36",
        "correta": false,
        "explicacao_especifica": "Contagem errônea."
      },
      {
        "letra": "D",
        "texto": "1/4",
        "correta": false,
        "explicacao_especifica": "9/36 = 1/4."
      },
      {
        "letra": "E",
        "texto": "5/36",
        "correta": false,
        "explicacao_especifica": "Casos de soma 6 ou 8."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        ...
        "texto": "15%",
        "correta": false,
        "explicacao_especifica": "Apenas 20 - 5 = 15%."
      },
      {
        "letra": "B",
        "texto": "25%",
        "correta": true,
        "explicacao_especifica": "20 + 10 - 5 = 25 veículos em 100 = 25%."
      },
      {
        "letra": "C",
        "texto": "30%",
        "correta": false,
        "explicacao_especifica": "Soma direta sem subtrair a interseção (20+10)."
      },
      {
        "letra": "D",
        "texto": "35%",
      ...
      },
      {
        ...
        "texto": "5%",
        "correta": false,
        "explicacao_especifica": "Esta é a probabilidade da interseção."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "Silogismo categórico válido modo Celarent (EAE-1): Todo A é B; Nenhum B é C; logo Nenhum A é C."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Incorreto. A dedução lógica por diagramas de Venn é categórica e incontestável."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "letra": "A",
        "texto": "Todos os investigadores dominam informática forense.",
        "correta": false,
        "explicacao_especifica": "Generalização indevida além das premissas."
      },
      {
        "letra": "B",
        "texto": "Nenhum investigador domina informática forense.",
        "correta": false,
        "explicacao_especifica": "Contradiz as premissas."
      },
      {
        "letra": "C",
        "texto": "Alguns investigadores dominam informática forense.",
        "correta": true,
        "explicacao_especifica": "Se alguns falam inglês e todos que falam inglês dominam informática, esse grupo que fala inglês domina informática forense."
      },
      {
        "letra": "D",
        "texto": "Quem não é investigador não domina informática forense.",
        "correta": false,
        "explicacao_especifica": "Nada foi afirmado sobre quem não é investigador."
      },
      {
        "letra": "E",
        "texto": "Todos os que dominam informática forense são investigadores.",
        "correta": false,
        "explicacao_especifica": "Conversão inválida do quantificador universal."
      }
    ]
  },
  {
    ...
    "alternativas": [
      ...
      },
      {
        ...
        "texto": "10",
        "correta": true,
        "explicacao_especifica": "Total união = 40. Complementar = 50 - 40 = 10 guardas."
      },
      {
        "letra": "C",
        "texto": "15",
        "correta": false,
        "explicacao_especifica": "15 é o número dos que praticam ambas."
      },
      {
        "letra": "D",
        "texto": "20",
        "correta": false,
        "explicacao_especifica": "Cálculo errôneo."
      },
      {
        "letra": "E",
        "texto": "25",
