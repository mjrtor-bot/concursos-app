    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "Trata-se de uma proposição composta conjuntiva (P ∧ Q)."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Item incorreto. A sentença é tipicamente uma proposição lógica composta."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "letra": "A",
        "texto": "Feche a porta da delegacia imediatamente!",
        "correta": true,
        "explicacao_especifica": "Frase imperativa (ordem); não expressa valor lógico V ou F."
      },
      {
        "letra": "B",
        "texto": "O suspeito foi preso em flagrante delito no aeroporto.",
        "correta": false,
        "explicacao_especifica": "Sentença declarativa fechada com sentido completo (proposição)."
      },
      {
        "letra": "C",
        "texto": "Todo crime hediondo é inafiançável.",
        "correta": false,
        "explicacao_especifica": "Sentença declarativa passível de juízo de valor (proposição)."
      },
      {
        "letra": "D",
        "texto": "A viatura policial percorreu 150 quilômetros durante a ronda.",
        "correta": false,
        "explicacao_especifica": "Sentença declarativa com predicado determinado (proposição)."
      },
      {
        "letra": "E",
        "texto": "A perícia papiloscópica identificou três impressões digitais.",
        "correta": false,
        "explicacao_especifica": "Sentença declarativa com valor de verdade verificável (proposição)."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "Fórmula 2^n: com n = 4 proposições simples, 2^4 = 16 linhas."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Incorreto. O número exato de linhas é 2^4 = 16."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "letra": "A",
        "texto": "Os agentes não chegaram em menos de 5 minutos.",
        "correta": false,
        "explicacao_especifica": "Contradiz a dedução lógica."
      },
      {
        "letra": "B",
        "texto": "A viatura não foi acionada.",
        "correta": false,
        "explicacao_especifica": "Como o alarme disparou, a viatura foi acionada por modus ponens."
      },
      {
        "letra": "C",
        "texto": "Os agentes chegam em menos de 5 minutos.",
        "correta": true,
        "explicacao_especifica": "Conclusão válida por transitividade condicional e afirmação do antecedente."
      },
      {
        "letra": "D",
        "texto": "O alarme disparou mas não houve invasão.",
        "correta": false,
        "explicacao_especifica": "Não há dados sobre invasão nas premissas."
      },
      {
        "letra": "E",
        "texto": "A viatura chegou atrasada em mais de 10 minutos.",
        "correta": false,
        "explicacao_especifica": "Falsa conclusão incompatível com as premissas."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "Definição formal de tautologia na lógica matemática."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Item incorreto. Tautologia é a proposição cujo valor lógico final é invariavelmente verdadeiro."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "letra": "A",
        "texto": "P for falso e Q for falso.",
        "correta": false,
        "explicacao_especifica": "F → F resulta em Verdadeiro."
      },
      {
        "letra": "B",
        "texto": "P for verdadeiro e Q for falso.",
        "correta": true,
        "explicacao_especifica": "V → F é o único caso em que a condicional se torna Falsa."
      },
      {
        "letra": "C",
        "texto": "P for falso e Q for verdadeiro.",
        "correta": false,
        "explicacao_especifica": "F → V resulta em Verdadeiro."
      },
      {
        "letra": "D",
        "texto": "P for verdadeiro e Q for verdadeiro.",
        "correta": false,
        "explicacao_especifica": "V → V resulta em Verdadeiro."
      },
      {
        "letra": "E",
        "texto": "P for equivalente a Q.",
        "correta": false,
        "explicacao_especifica": "Se ambos têm o mesmo valor, P → Q é Verdadeiro."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "Aplicação exata da 1ª Lei de De Morgan: ~(P ∧ Q) ≡ ~P ∨ ~Q."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Item incorreto. A negação lógica de 'P e Q' é 'não P ou não Q'."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "letra": "A",
        "texto": "Se o suspeito não confessar o crime, então o juiz não concederá a liberdade provisória.",
        "correta": false,
        "explicacao_especifica": "Isto é a inversa (~P → ~Q), não a negação."
      },
      {
        "letra": "B",
        "texto": "O suspeito confessou o crime e o juiz não concedeu a liberdade provisória.",
        "correta": true,
        "explicacao_especifica": "Negação de P → Q: P ∧ ~Q (mantém a primeira e nega a segunda)."
      },
      {
        "letra": "C",
        "texto": "O suspeito não confessou o crime ou o juiz concedeu a liberdade provisória.",
        "correta": false,
        "explicacao_especifica": "Esta é uma equivalência (~P ∨ Q), não a negação."
      },
      {
        "letra": "D",
        "texto": "Se o juiz não conceder a liberdade provisória, então o suspeito não confessou o crime.",
        "correta": false,
        "explicacao_especifica": "Esta é a contrapositiva (~Q → ~P), que é equivalente."
      },
      {
        "letra": "E",
        "texto": "O suspeito não confessou o crime e o juiz não concedeu a liberdade provisória.",
        "correta": false,
        "explicacao_especifica": "Nega ambas as proposições incorretamente."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "Equivalência lógica por contraposição: P → Q ≡ ~Q → ~P."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Item incorreto. A contrapositiva preserva perfeitamente a tabela-verdade da condicional."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "letra": "A",
        "texto": "O mandado de busca é expedido e a operação será cancelada.",
        "correta": false,
        "explicacao_especifica": "Conjunção não equivale a 'ou... ou'."
      },
      {
        "letra": "B",
        "texto": "O mandado de busca é expedido se, e somente se, a operação não for cancelada.",
        "correta": true,
        "explicacao_especifica": "P ⊻ Q é equivalente a P ↔ ~Q (bicondicional com um lado negado)."
      },
      {
        "letra": "C",
        "texto": "Se o mandado for expedido, a operação será cancelada.",
        "correta": false,
        "explicacao_especifica": "Condicional simples não equivale a disjunção exclusiva."
      },
      {
        "letra": "D",
        "texto": "O mandado não foi expedido e a operação não foi cancelada.",
        "correta": false,
        "explicacao_especifica": "Negação simultânea que tornaria a disjunção exclusiva falsa."
      },
      {
        "letra": "E",
        "texto": "A operação será cancelada somente se o mandado for expedido.",
        "correta": false,
        "explicacao_especifica": "Sentença condicional assimétrica."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": false,
        "explicacao_especifica": "Item incorreto. A negação de 'Todo' é 'Algum... não', e não 'Nenhum'."
      },
      {
        "texto": "Errado",
        "correta": true,
        "explicacao_especifica": "Gabarito Errado. A negação de 'Todo A é B' é 'Existe pelo menos um A que não é B'."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "letra": "A",
        "texto": "Todos os investigados estão foragidos.",
        "correta": false,
        "explicacao_especifica": "Generalização afirmativa incorreta."
      },
      {
        "letra": "B",
        "texto": "Nenhum investigado está foragido.",
        "correta": true,
        "explicacao_especifica": "Negação correta do quantificador existencial pelo universal negativo."
      },
      {
        "letra": "C",
        "texto": "Existe algum investigado preso.",
        "correta": false,
        "explicacao_especifica": "Não é a negação contraditória rigorosa."
      },
      {
        "letra": "D",
        "texto": "A maioria dos investigados está foragida.",
        "correta": false,
        "explicacao_especifica": "Quantificador indefinido."
      },
      {
        "letra": "E",
        "texto": "Dois investigados não estão foragidos.",
        "correta": false,
        "explicacao_especifica": "Quantificação numérica restrita."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "C(7,4) = 35 equipes distintas, o que é superior a 30."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Item incorreto. O cálculo resulta em exatamente 35 comissões (> 30)."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        ...
        "texto": "15",
        "correta": false,
        "explicacao_especifica": "Cálculo de combinação simples C(6,4)."
      },
      {
        "letra": "B",
        "texto": "120",
        "correta": false,
        "explicacao_especifica": "Cálculo de A(6,3)."
      },
      {
        "letra": "C",
        "texto": "360",
        "correta": true,
        "explicacao_especifica": "Arranjo simples: 6 × 5 × 4 × 3 = 360 senhas distintas."
      },
      {
        "letra": "D",
        "texto": "720",
        "correta": false,
        "explicacao_especifica": "Permutação de 6 elementos (6!)."
      },
      {
        "letra": "E",
        "texto": "1.296",
        "correta": false,
        "explicacao_especifica": "Arranjo com repetição (6^4)."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "P_7^(2) = 7! / 2! = 5040 / 2 = 2520 anagramas distintos."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Item incorreto. O cálculo de permutação com repetição da letra 'I' resulta exatamente em 2.520."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        ...
        "texto": "66",
        "correta": false,
        "explicacao_especifica": "Soma das combinações em vez do produto."
      },
      {
        "letra": "B",
        "texto": "280",
        "correta": false,
        "explicacao_especifica": "Cálculo parcial."
      },
      {
        "letra": "C",
        "texto": "560",
        "correta": true,
        "explicacao_especifica": "C(5,2) × C(8,3) = 10 × 56 = 560 comissões distintas."
      },
      {
        "letra": "D",
        "texto": "1.120",
        "correta": false,
        "explicacao_especifica": "Valor dobrado."
      },
      {
        "letra": "E",
        "texto": "3.360",
        "correta": false,
        "explicacao_especifica": "Cálculo por arranjos em vez de combinações."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "P(sem defeito) = 16/20 = 80%."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Incorreto. A probabilidade do evento complementar é exatamente 16/20 = 80%."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        ...
        "texto": "5/28",
        "correta": false,
        "explicacao_especifica": "Fração incorreta."
      },
      {
        "letra": "B",
        "texto": "5/14",
        "correta": true,
        "explicacao_especifica": "P = C(5,2) / C(8,2) = 10 / 28 = 5/14."
      },
      {
        "letra": "C",
        "texto": "15/56",
        "correta": false,
        "explicacao_especifica": "Probabilidade de 1 de cada calibre."
      },
      {
        "letra": "D",
        "texto": "3/28",
        "correta": false,
        "explicacao_especifica": "Probabilidade de ambos serem 9mm: C(3,2)/28 = 3/28."
      },
      {
        "letra": "E",
        "texto": "1/2",
        "correta": false,
        "explicacao_especifica": "Razão não correspondente ao cálculo combinatório."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "Conclusão logicamente válida pelo diagrama de Venn dos conjuntos."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Incorreto. A intersecção não vazia entre Peritos e Químicos garante a intersecção entre Graduados e Químicos."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        ...
        "texto": "5",
        "correta": false,
        "explicacao_especifica": "Cálculo incorreto."
      },
      {
        "letra": "B",
        "texto": "10",
        "correta": true,
        "explicacao_especifica": "100 - (60 + 50 - 20) = 100 - 90 = 10."
      },
      {
        "letra": "C",
        "texto": "15",
        "correta": false,
        "explicacao_especifica": "Subtração errada."
      },
      {
        "letra": "D",
        "texto": "20",
        "correta": false,
        "explicacao_especifica": "20 é o número de policiais que operam ambos."
      },
      {
        "letra": "E",
        "texto": "30",
        "correta": false,
        "explicacao_especifica": "Valor discrepante do diagrama de Venn."
      }
    ]
  }
];
