export const infoQuestions = [
  {
    ...
    "assunto_id": "afa6fc9a-58eb-5b53-bf8a-f56021b629e4",
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "Conceito clássico e exato de ransomware na segurança da informação."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Incorreto. A definição de ransomware corresponde com exatidão ao enunciado."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "Regra fundamental da criptografia de chave pública para garantia de sigilo."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Incorreto. Apenas a chave privada correlata consegue decodificar a mensagem cifrada pela chave pública."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        ...
        "correta": false,
        "explicacao_especifica": "Garante que o acesso seja restrito a pessoas autorizadas."
      },
      {
        "letra": "B",
        "texto": "Integridade.",
        "correta": true,
        "explicacao_especifica": "Garante que a informação não foi modificada ou corrompida."
      },
      {
        "letra": "C",
        "texto": "Disponibilidade.",
        "correta": false,
        "explicacao_especifica": "Garante acesso quando solicitado por usuários autorizados."
      },
      {
        "letra": "D",
        "texto": "Autenticidade.",
        "correta": false,
        "explicacao_especifica": "Garante a identidade do emissor."
      },
      {
        "letra": "E",
        "texto": "Não repúdio.",
        "correta": false,
        "explicacao_especifica": "Impede que o emissor negue a autoria da mensagem."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "Assinatura digital não criptografa o documento para fins de sigilo, apenas assina seu hash."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Incorreto. A assinatura digital não fornece confidencialidade sem cifragem adicional."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        ...
        "texto": "Trojan.",
        "correta": false,
        "explicacao_especifica": "Cavalo de Troia é um programa que aparenta ser útil mas executa ações maliciosas."
      },
      {
        "letra": "B",
        "texto": "Phishing.",
        "correta": true,
        "explicacao_especifica": "Engenharia social que atrai vítimas para páginas fraudulentas visando roubar senhas/dados."
      },
      {
        "letra": "C",
        "texto": "Spyware.",
        "correta": false,
        "explicacao_especifica": "Software espião focado em monitorar atividades do usuário."
      },
      {
        "letra": "D",
        "texto": "Rootkit.",
        "correta": false,
        "explicacao_especifica": "Conjunto de ferramentas que mantém acesso privilegiado e oculta malwares."
      },
      {
        "letra": "E",
        "texto": "Adware.",
        "correta": false,
        "explicacao_especifica": "Programa que exibe anúncios publicitários indesejados."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "Função primordial do firewall corporativo ou de perímetro."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Incorreto. O firewall executa exatamente o controle e filtragem do tráfego com base em políticas de segurança."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        ...
        "texto": "RSA.",
        "correta": false,
        "explicacao_especifica": "Algoritmo de chave pública (assimétrico)."
      },
      {
        "letra": "B",
        "texto": "AES.",
        "correta": true,
        "explicacao_especifica": "Padrão de cifragem de bloco simétrico adotado mundialmente."
      },
      {
        "letra": "C",
        "texto": "ECC.",
        "correta": false,
        "explicacao_especifica": "Criptografia de curvas elípticas (assimétrica)."
      },
      {
        "letra": "D",
        "texto": "DSA.",
        "correta": false,
        "explicacao_especifica": "Digital Signature Algorithm (assimétrico)."
      },
      {
        "letra": "E",
        "texto": "SHA-256.",
        "correta": false,
        "explicacao_especifica": "Função de resumo criptográfico unidirecional (hash), não cifra simétrica."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "Os três pilares da autenticação: saber, ter e ser."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Incorreto. A autenticação em dois fatores apoia-se exatamente em categorias distintas de credenciais."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "letra": "A",
        "texto": "Vírus de macro.",
        "correta": false,
        "explicacao_especifica": "Precisa de arquivo infectado aberto pelo usuário."
      },
      {
        "letra": "B",
        "texto": "Worm.",
        "correta": true,
        "explicacao_especifica": "Propaga-se de forma autônoma e autorreplicante por redes."
      },
      {
        "letra": "C",
        "texto": "Spyware.",
        "correta": false,
        "explicacao_especifica": "Malware de vigilância e captura de dados."
      },
      {
        "letra": "D",
        "texto": "Rootkit.",
        "correta": false,
        "explicacao_especifica": "Conjunto de ocultação e acesso privilegiado."
      },
      {
        "letra": "E",
        "texto": "Keylogger.",
        "correta": false,
        "explicacao_especifica": "Capturador de teclas digitadas."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "Propriedades criptográficas fundamentais do padrão SHA-2."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Incorreto. A resistência a colisões e a unidirecionalidade são pilares do hash criptográfico."
      }
    ]
  },
  {
    "idSlug": "info-11",
    "disciplina_id": "4598b6df-6e9d-5916-aa39-bb82ec4f41a6",
    "assunto_id": "0f3e684d-8133-528d-97ac-a8b175acb75d",
    "banca_nome": "CEBRASPE (CESPE)",
    "orgao_nome": "Polícia Federal (PF)",
    "cargo_nome": "Agente de Polícia Federal",
    "ano": 2024,
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "HTTPS usa TCP 443 e criptografia TLS/SSL na camada de aplicação."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Incorreto. A porta padrão e o mecanismo de proteção do HTTPS estão corretos."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        ...
        "texto": "UDP.",
        "correta": false,
        "explicacao_especifica": "Protocolo não confiável e sem conexão prévia (stateless)."
      },
      {
        "letra": "B",
        "texto": "TCP.",
        "correta": true,
        "explicacao_especifica": "Orientado a conexão com three-way handshake, confirmação (ACK) e retransmissão."
      },
      {
        "letra": "C",
        "texto": "IP.",
        "correta": false,
        "explicacao_especifica": "Protocolo da camada de rede (Internet)."
      },
      {
        "letra": "D",
        "texto": "ICMP.",
        "correta": false,
        "explicacao_especifica": "Protocolo de controle de rede/mensagens de erro (camada de rede)."
      },
      {
        "letra": "E",
        "texto": "ARP.",
        "correta": false,
        "explicacao_especifica": "Resolução de endereço IP para MAC (camada de enlace/rede)."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "Função primordial do protocolo DHCP na camada de aplicação/transporte UDP 67/68."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Incorreto. O DHCP executa com precisão a concessão automática de IP, máscara e gateway."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        ...
        "texto": "FTP.",
        "correta": false,
        "explicacao_especifica": "Transferência de arquivos (portas 20/21)."
      },
      {
        "letra": "B",
        "texto": "DNS.",
        "correta": true,
        "explicacao_especifica": "Sistema de Resolução de Nomes de Domínio em endereços IP."
      },
      {
        "letra": "C",
        "texto": "SNMP.",
        "correta": false,
        "explicacao_especifica": "Gerenciamento de dispositivos de rede."
      },
      {
        "letra": "D",
        "texto": "SMTP.",
        "correta": false,
        "explicacao_especifica": "Envio de correio eletrônico (e-mail)."
      },
      {
        "letra": "E",
        "texto": "SSH.",
        "correta": false,
        "explicacao_especifica": "Acesso remoto seguro por terminal."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "Estrutura técnica exata do IPv6 em 128 bits e base hexadecimal."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Incorreto. O IPv6 possui exatamente 128 bits estruturados em notação hexadecimal."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "letra": "A",
        "texto": "IaaS (Infrastructure as a Service).",
        "correta": false,
        "explicacao_especifica": "Locação de servidores virtuais, discos e rede."
      },
      {
        "letra": "B",
        "texto": "PaaS (Platform as a Service).",
        "correta": false,
        "explicacao_especifica": "Ambiente para desenvolvedores criarem softwares."
      },
      {
        "letra": "C",
        "texto": "SaaS (Software as a Service).",
        "correta": true,
        "explicacao_especifica": "Aplicações prontas para uso final via web/app sem gestão de infraestrutura."
      },
      {
        "letra": "D",
        "texto": "DaaS (Desktop as a Service).",
        "correta": false,
        "explicacao_especifica": "Virtualização pontual de desktops."
      },
      {
        "letra": "E",
        "texto": "BaaS (Backend as a Service).",
        "correta": false,
        "explicacao_especifica": "Serviços específicos de backend para apps."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "Definição formal de rede privada virtual e tunelamento seguro."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Incorreto. A VPN realiza exatamente o encapsulamento seguro e criptografado sobre redes abertas."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        ...
        "texto": "SMTP.",
        "correta": false,
        "explicacao_especifica": "Protocolo de envio (transporte) de e-mails."
      },
      {
        "letra": "B",
        "texto": "IMAP.",
        "correta": false,
        "explicacao_especifica": "Acesso síncrono mantendo cópia das mensagens no servidor remoto."
      },
      {
        "letra": "C",
        "texto": "POP3.",
        "correta": true,
        "explicacao_especifica": "Baixa as mensagens para a máquina local com remoção padrão no servidor."
      },
      {
        "letra": "D",
        "texto": "HTTP.",
        "correta": false,
        "explicacao_especifica": "Protocolo web genérico."
      },
      {
        "letra": "E",
        "texto": "FTP.",
        "correta": false,
        "explicacao_especifica": "Transferência de arquivos em geral."
      }
    ]
  },
  {
    "idSlug": "info-19",
    "disciplina_id": "4598b6df-6e9d-5916-aa39-bb82ec4f41a6",
    "assunto_id": "b4ed475a-eda4-5383-a1a8-b0316ae4c653",
    "banca_nome": "CEBRASPE (CESPE)",
    "orgao_nome": "Polícia Federal (PF)",
    "cargo_nome": "Agente de Polícia Federal",
    "ano": 2024,
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "Cálculo exato das permissões em octal no padrão POSIX/Linux."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Incorreto. O valor octal 755 atribui rwx ao dono e r-x aos demais."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        ...
        "texto": "find",
        "correta": false,
        "explicacao_especifica": "Busca arquivos e pastas na hierarquia de diretórios."
      },
      {
        "letra": "B",
        "texto": "grep",
        "correta": true,
        "explicacao_especifica": "Filtra e busca ocorrências de texto via expressões regulares dentro de arquivos."
      },
      {
        "letra": "C",
        "texto": "ls",
        "correta": false,
        "explicacao_especifica": "Lista conteúdo de diretórios."
      },
      {
        "letra": "D",
        "texto": "chmod",
        "correta": false,
        "explicacao_especifica": "Altera permissões de acesso a arquivos."
      },
      {
        "letra": "E",
        "texto": "cat",
        "correta": false,
        "explicacao_especifica": "Concatena e exibe o conteúdo integral de arquivos."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "Funcionalidade nativa de criptografia de partição do Microsoft Windows."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Incorreto. O BitLocker é a ferramenta oficial de Full Disk Encryption do Windows."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        ...
        "texto": "/bin",
        "correta": false,
        "explicacao_especifica": "Armazena binários executáveis essenciais do sistema."
      },
      {
        "letra": "B",
        "texto": "/etc",
        "correta": true,
        "explicacao_especifica": "Diretório padrão de arquivos de configuração no padrão FHS Linux."
      },
      {
        "letra": "C",
        "texto": "/home",
        "correta": false,
        "explicacao_especifica": "Diretório de pastas pessoais dos usuários comuns."
      },
      {
        "letra": "D",
        "texto": "/var",
        "correta": false,
        "explicacao_especifica": "Armazena dados variáveis como logs e spoolers."
      },
      {
        "letra": "E",
        "texto": "/tmp",
        "correta": false,
        "explicacao_especifica": "Diretório para armazenamento de arquivos temporários."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "Propriedade nativa de sensibilidade a caixa (case-sensitive) do Linux."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Incorreto. O Linux diferencia estritamente maiúsculas e minúsculas."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "letra": "A",
        "texto": "Ctrl + Shift + Esc",
        "correta": false,
        "explicacao_especifica": "Abre o Gerenciador de Tarefas diretamente."
      },
      {
        "letra": "B",
        "texto": "Alt + Tab",
        "correta": true,
        "explicacao_especifica": "Alterna janelas ativas em execução."
      },
      {
        "letra": "C",
        "texto": "Windows + L",
        "correta": false,
        "explicacao_especifica": "Bloqueia a sessão do computador."
      },
      {
        "letra": "D",
        "texto": "Ctrl + Alt + Del",
        "correta": false,
        "explicacao_especifica": "Abre a tela de opções de segurança do sistema."
      },
      {
        "letra": "E",
        "texto": "Windows + D",
        "correta": false,
        "explicacao_especifica": "Mostra ou oculta a Área de Trabalho."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "Sintaxe e comportamento padrão ANSI SQL para eliminação de duplicidades."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Incorreto. A cláusula DISTINCT tem exatamente a função de retornar apenas valores únicos."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        ...
        "texto": "De domínio.",
        "correta": false,
        "explicacao_especifica": "Restringe os valores aceitos por uma coluna (tipo, faixa)."
      },
      {
        "letra": "B",
        "texto": "Referencial.",
        "correta": true,
        "explicacao_especifica": "Garante vínculos válidos entre chaves primárias e estrangeiras."
      },
      {
        "letra": "C",
        "texto": "De entidade.",
        "correta": false,
        "explicacao_especifica": "Determina que chaves primárias não podem ser nulas nem duplicadas."
      },
      {
        "letra": "D",
        "texto": "Semântica.",
        "correta": false,
        "explicacao_especifica": "Regras de negócio personalizadas."
      },
      {
        "letra": "E",
        "texto": "Transacional.",
        "correta": false,
        "explicacao_especifica": "Conceito ligado a propriedades ACID."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "Características basilares dos bancos NoSQL em soluções de Big Data."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Incorreto. A ausência de esquema rígido e escalabilidade são pontos fortes dos SGBDs NoSQL."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        ...
        "texto": "ALTER TABLE",
        "correta": false,
        "explicacao_especifica": "Comando DDL para alterar a estrutura de colunas da tabela."
      },
      {
        "letra": "B",
        "texto": "UPDATE",
        "correta": true,
        "explicacao_especifica": "Comando DML para atualizar valores de registros existentes."
      },
      {
        "letra": "C",
        "texto": "MODIFY",
        "correta": false,
        "explicacao_especifica": "Cláusula usada dentro do ALTER TABLE."
      },
      {
        "letra": "D",
        "texto": "SET DATA",
        "correta": false,
        "explicacao_especifica": "Comando inexistente na norma SQL."
      },
      {
        "letra": "E",
        "texto": "CHANGE",
        "correta": false,
        "explicacao_especifica": "Comando DDL específico de alguns SGBDs."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "Significado conceitual exato da sigla ACID."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Incorreto. A definição abrange com rigor os quatro princípios ACID."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "letra": "A",
        "texto": "Volume, Velocidade e Variedade.",
        "correta": true,
        "explicacao_especifica": "Os 3 'Vs' originais que caracterizam Big Data."
      },
      {
        "letra": "B",
        "texto": "Visibilidade, Vetorização e Validação.",
        "correta": false,
        "explicacao_especifica": "Termos não relacionados à tríade de Big Data."
      },
      {
        "letra": "C",
        "texto": "Virtualização, Versatilidade e Vulnerabilidade.",
        "correta": false,
        "explicacao_especifica": "Conceitos de infraestrutura e segurança."
      },
      {
        "letra": "D",
        "texto": "Vigilância, Variação e Verificação.",
        "correta": false,
        "explicacao_especifica": "Termos desconexos da literatura clássica de Big Data."
      },
      {
        "letra": "E",
        "texto": "Vínculo, Volatilidade e Visão.",
        "correta": false,
        "explicacao_especifica": "Classificação incorreta."
      }
    ]
  }
];
