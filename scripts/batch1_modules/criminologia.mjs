export const crimQuestions = [
  {
    "idSlug": "crim-01",
    "disciplina_id": "0321c3c1-167a-5a44-a59d-89c065d0426d",
    "assunto_id": "e9d58ff5-4eb1-5234-b8ff-670ac90da24a",
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "A Escola Clássica consagra o livre-arbítrio e a concepção do crime como ente jurídico."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Item incorreto. Carrara e Beccaria fundamentam a culpabilidade no livre-arbítrio e na quebra contratual."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "letra": "A",
        "texto": "Cesare Beccaria, Jeremy Bentham e Francesco Carrara.",
        "correta": false,
        "explicacao_especifica": "Estes são expoentes da Escola Clássica e Utilitarista."
      },
      {
        "letra": "B",
        "texto": "Cesare Lombroso, Enrico Ferri e Raffaele Garofalo.",
        "correta": true,
        "explicacao_especifica": "A tríade fundamental da Escola Positiva Italiana."
      },
      {
        "letra": "C",
        "texto": "Robert Merton, Edwin Sutherland e Howard Becker.",
        "correta": false,
        "explicacao_especifica": "Teóricos da sociologia criminal norte-americana (Anomia, Associação Diferencial e Labeling)."
      },
      {
        "letra": "D",
        "texto": "Franz von Liszt, Adolphe Quetelet e Gabriel Tarde.",
        "correta": false,
        "explicacao_especifica": "Liszt pertence à Escola Alemã e Quetelet à Estatística Moral."
      },
      {
        "letra": "E",
        "texto": "Emile Durkheim, Michel Foucault e Alessandro Baratta.",
        "correta": false,
        "explicacao_especifica": "Durkheim é sociólogo clássico e Baratta da Criminologia Crítica."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "Definição exata da Teoria da Tensão e Anomia de Robert K. Merton."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Incorreto. A anomia em Merton é justamente a discrepância entre metas culturais e meios institucionais."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "letra": "A",
        "texto": "O crime decorre de defeitos genéticos e desvios cromossômicos hereditários.",
        "correta": false,
        "explicacao_especifica": "Visão biopsicológica positivista superada."
      },
      {
        "letra": "B",
        "texto": "A criminalidade é uma propriedade atribuída a determinados indivíduos por meio de processos seletivos e estigmatizantes de controle formal.",
        "correta": true,
        "explicacao_especifica": "Núcleo do Labeling Approach (Howard Becker, Erving Goffman)."
      },
      {
        "letra": "C",
        "texto": "A desorganização urbana das zonas de transição gera a perda de controle social informal.",
        "correta": false,
        "explicacao_especifica": "Teoria Ecológica da Escola de Chicago."
      },
      {
        "letra": "D",
        "texto": "O delito é conduta aprendida em relações sociais íntimas com outros criminosos.",
        "correta": false,
        "explicacao_especifica": "Teoria da Associação Diferencial de Sutherland."
      },
      {
        "letra": "E",
        "texto": "A punição deve visar à neutralização incapacitante dos criminosos irrecuperáveis.",
        "correta": false,
        "explicacao_especifica": "Postulado do Direito Penal do Inimigo / Positivismo radical."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "Broken Windows Theory postula que desordem visível e impunidade geram desintegração social e atração de criminalidade violenta."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Item incorreto. A teoria relaciona expressamente a tolerância a pequenas infrações com o aumento de delitos graves."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "letra": "A",
        "texto": "Criminoso nato e atavismo morfológico.",
        "correta": false,
        "explicacao_especifica": "Conceito de Cesare Lombroso."
      },
      {
        "letra": "B",
        "texto": "Crime de colarinho branco (white-collar crime).",
        "correta": true,
        "explicacao_especifica": "Sutherland formulou a teoria e cunhou os crimes de colarinho branco."
      },
      {
        "letra": "C",
        "texto": "Vitimologia terciária e revitimização institucional.",
        "correta": false,
        "explicacao_especifica": "Conceito da Vitimologia."
      },
      {
        "letra": "D",
        "texto": "Delinquência passional por impulso incontrolável.",
        "correta": false,
        "explicacao_especifica": "Classificação de Enrico Ferri."
      },
      {
        "letra": "E",
        "texto": "Controle social formal reativo.",
        "correta": false,
        "explicacao_especifica": "Conceito genérico da sociologia jurídica."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "A Criminologia Crítica denuncia a seletividade e funcionalidade reprodutora de desigualdades do sistema penal."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Item incorreto. A tese da seletividade estrutural e controle de classes é a espinha dorsal da criminologia crítica."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "letra": "A",
        "texto": "Ao crescimento desordenado das cidades, à desorganização social e à degradação física dos bairros de transição.",
        "correta": true,
        "explicacao_especifica": "Foco ecológico-espacial da Escola de Chicago."
      },
      {
        "letra": "B",
        "texto": "À baixa capacidade craniana e deformações anatômicas atávicas.",
        "correta": false,
        "explicacao_especifica": "Positivismo antropológico de Lombroso."
      },
      {
        "letra": "C",
        "texto": "Ao livre-arbítrio como única fonte do comportamento humano delinquente.",
        "correta": false,
        "explicacao_especifica": "Postulado da Escola Clássica."
      },
      {
        "letra": "D",
        "texto": "À predisposição genética transmitida por cromossomos anormais (XYY).",
        "correta": false,
        "explicacao_especifica": "Criminologia biológica/genética."
      },
      {
        "letra": "E",
        "texto": "À manipulação da opinião pública pela mídia sensacionalista.",
        "correta": false,
        "explicacao_especifica": "Teoria do Pânico Moral."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "Sykes e Matza demonstraram que o delinquente utiliza técnicas de neutralização para silenciar a censura moral interior."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Item incorreto. Essa é a definição consagrada das técnicas de neutralização na criminologia sociológica."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "letra": "A",
        "texto": "Teoria da Subcultura Delinquente (Albert Cohen).",
        "correta": false,
        "explicacao_especifica": "Foca em subculturas juvenis e valores contraculturais não utilitários."
      },
      {
        "letra": "B",
        "texto": "Teoria da Escolha Racional e Atividades Rotineiras (Cohen e Felson).",
        "correta": true,
        "explicacao_especifica": "Convergência temporal de autor motivado, alvo vulnerável e guardião ausente."
      },
      {
        "letra": "C",
        "texto": "Teoria do Vínculo Social (Travis Hirschi).",
        "correta": false,
        "explicacao_especifica": "Explica a conformidade pelo apego, compromisso, envolvimento e crença."
      },
      {
        "letra": "D",
        "texto": "Teoria da Anomia Institucional (Messner e Rosenfeld).",
        "correta": false,
        "explicacao_especifica": "Foca no desequilíbrio entre economia e outras instituições."
      },
      {
        "letra": "E",
        "texto": "Teoria da Rotulação Social (Howard Becker).",
        "correta": false,
        "explicacao_especifica": "Foca na estigmatização das agências de controle."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "Donald Clemmer conceituou prisionização como a assimilação da subcultura e código prisional pelo apenado."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Item incorreto. O termo retrata com exatidão os efeitos degradantes da institucionalização carcerária."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "letra": "A",
        "texto": "Apenas a lei penal substantiva e os procedimentos recursais processuais.",
        "correta": false,
        "explicacao_especifica": "Objeto da dogmática jurídico-penal e processual."
      },
      {
        "letra": "B",
        "texto": "O crime, o criminoso, a vítima e o controle social.",
        "correta": true,
        "explicacao_especifica": "Tetralogia clássica de objetos da moderna Criminologia."
      },
      {
        "letra": "C",
        "texto": "Exclusivamente a anatomia patológica e a genética criminal.",
        "correta": false,
        "explicacao_especifica": "Objeto restrito da antropologia criminal/medicina legal."
      },
      {
        "letra": "D",
        "texto": "As penas privativas de liberdade e seu cumprimento penitenciário apenas.",
        "correta": false,
        "explicacao_especifica": "Objeto da Penologia e Execução Penal."
      },
      {
        "letra": "E",
        "texto": "A formulação de políticas partidárias de segurança pública.",
        "correta": false,
        "explicacao_especifica": "Objeto da Política Criminal governamental."
      }
    ]
  },
  {
    "idSlug": "crim-13",
    "disciplina_id": "0321c3c1-167a-5a44-a59d-89c065d0426d",
    "assunto_id": "079aff83-cc64-59d6-92e8-b6c1691c5392",
    "banca_nome": "CEBRASPE (CESPE)",
    "orgao_nome": "Polícia Federal (PF)",
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "Diferenciação precisa entre vitimização primária e secundária na esteira doutrinária."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Incorreto. A conceituação espelha com fidelidade as categorias vitimológicas."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "letra": "A",
        "texto": "Vítima completamente inocente ou ideal.",
        "correta": false,
        "explicacao_especifica": "Não tem qualquer participação no evento (ex.: vítima de bala perdida)."
      },
      {
        "letra": "B",
        "texto": "Vítima mais culpada que o infrator (vítima provocadora).",
        "correta": true,
        "explicacao_especifica": "Classificação precisa de Benjamin Mendelsohn para quem provoca a reação delituosa."
      },
      {
        "letra": "C",
        "texto": "Vítima por ignorância ou menor culpabilidade.",
        "correta": false,
        "explicacao_especifica": "Age com descuido involuntário facilitando o delito."
      },
      {
        "letra": "D",
        "texto": "Vítima simulada ou imaginária.",
        "correta": false,
        "explicacao_especifica": "Inventa o delito ou sofre de delírio persecutório."
      },
      {
        "letra": "E",
        "texto": "Vítima terciária compulsória.",
        "correta": false,
        "explicacao_especifica": "Conceito alheio à tipologia clássica de Mendelsohn."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "A cifra dourada refere-se à impunidade estrutural dos crimes de colarinho branco e da criminalidade corporativa."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Item incorreto. Esta é a exata definição de Cifra Dourada cunhada pela criminologia crítica."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "letra": "A",
        "texto": "Jamais chegam ao conhecimento das autoridades policiais por desconfiança da vítima.",
        "correta": false,
        "explicacao_especifica": "Esta é a Cifra Negra."
      },
      {
        "letra": "B",
        "texto": "Chegam a ser registrados pela autoridade policial, mas são solucionados na delegacia ou não resultam em ação penal em juízo.",
        "correta": true,
        "explicacao_especifica": "Conceito de Cifra Cinza da criminalidade."
      },
      {
        "letra": "C",
        "texto": "Envolvem exclusivamente atos de corrupção sistêmica no alto escalão estatal.",
        "correta": false,
        "explicacao_especifica": "Esta é a Cifra Dourada."
      },
      {
        "letra": "D",
        "texto": "São praticados por agentes de segurança pública com violência desmedida.",
        "correta": false,
        "explicacao_especifica": "Esta é a Cifra Amarela."
      },
      {
        "letra": "E",
        "texto": "Foram solucionados com condenação definitiva e cumprimento integral de pena.",
        "correta": false,
        "explicacao_especifica": "Estatística oficial de condenações (criminalidade revelada)."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "A vitimização terciária decorre da falta de amparo e discriminação imposta pela sociedade e grupo próximo."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Incorreto. A descrição retrata precisamente o conceito de vitimização terciária."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "letra": "A",
        "texto": "Síndrome de Münchhausen.",
        "correta": false,
        "explicacao_especifica": "Transtorno factício em que a pessoa simula ou induz doenças."
      },
      {
        "letra": "B",
        "texto": "Síndrome de Estocolmo.",
        "correta": true,
        "explicacao_especifica": "Vínculo de empatia e defesa do agressor pela vítima em situação de cativeiro."
      },
      {
        "letra": "C",
        "texto": "Síndrome de Burnout.",
        "correta": false,
        "explicacao_especifica": "Esgotamento profissional crônico."
      },
      {
        "letra": "D",
        "texto": "Síndrome de Lima.",
        "correta": false,
        "explicacao_especifica": "Ocorre quando o sequestrador desenvolve compaixão pela vítima (fenômeno inverso)."
      },
      {
        "letra": "E",
        "texto": "Síndrome de Cotard.",
        "correta": false,
        "explicacao_especifica": "Delírio niilista de negação dos próprios órgãos/existência."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "A vitimodogmática analisa o peso jurídico da conduta da vítima no juízo de tipicidade e culpabilidade."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Item incorreto. A vitimodogmática é justamente a integração do papel da vítima na dogmática penal."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "letra": "A",
        "texto": "Idade do Ouro da vítima.",
        "correta": false,
        "explicacao_especifica": "Período da justiça privada onde a vítima exercia a vingança e recebia a composição."
      },
      {
        "letra": "B",
        "texto": "Neutralização (ou esquecimento) da vítima.",
        "correta": true,
        "explicacao_especifica": "O Estado monopolizou a punição e reduziu a vítima a objeto de prova."
      },
      {
        "letra": "C",
        "texto": "Redescoberta da vítima.",
        "correta": false,
        "explicacao_especifica": "Fase contemporânea de proteção aos direitos da vítima e justiça restaurativa."
      },
      {
        "letra": "D",
        "texto": "Era da punição vicária corporativa.",
        "correta": false,
        "explicacao_especifica": "Terminologia inadequada às fases históricas da vitimologia."
      },
      {
        "letra": "E",
        "texto": "Fase da hiperinflação vitimária.",
        "correta": false,
        "explicacao_especifica": "Expressão inexistente na periodização histórica."
      }
    ]
  },
  {
    "idSlug": "crim-21",
    "disciplina_id": "0321c3c1-167a-5a44-a59d-89c065d0426d",
    "assunto_id": "ff763285-f3a8-5836-83d0-b07fc54b7d29",
    "banca_nome": "CEBRASPE (CESPE)",
    "orgao_nome": "Polícia Federal (PF)",
    "cargo_nome": "Delegado de Polícia Federal",
    "ano": 2024,
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "A prevenção primária dirige-se à coletividade com ações estruturantes de longo prazo."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Item incorreto. A definição de prevenção primária abrange exatamente medidas universais e estruturantes."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "letra": "A",
        "texto": "Prevenção Primária.",
        "correta": false,
        "explicacao_especifica": "Atua nas bases sociais e educacionais universais da sociedade."
      },
      {
        "letra": "B",
        "texto": "Prevenção Secundária.",
        "correta": false,
        "explicacao_especifica": "Atua em grupos de risco e áreas conflagradas antes da condenação."
      },
      {
        "letra": "C",
        "texto": "Prevenção Terciária.",
        "correta": true,
        "explicacao_especifica": "Direciona-se ao condenado e egresso para impedir a reincidência."
      },
      {
        "letra": "D",
        "texto": "Prevenção Quaternária.",
        "correta": false,
        "explicacao_especifica": "Conceito da bioética/saúde para evitar intervenções iatrogênicas excessivas."
      },
      {
        "letra": "E",
        "texto": "Prevenção Retributiva Absoluta.",
        "correta": false,
        "explicacao_especifica": "Termo de teoria das penas, não de modelo criminológico de prevenção."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "A Justiça Restaurativa privilegia a mediação, a reparação do dano e a reintegração social das partes envolvidas."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Item incorreto. O modelo restaurativo é justamente baseado na participação ativa da vítima e restauração das relações sociais."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "letra": "A",
        "texto": "Valorização da mediação vítima-agressor com foco na justiça restaurativa.",
        "correta": false,
        "explicacao_especifica": "Oposto do Direito Penal do Inimigo."
      },
      {
        "letra": "B",
        "texto": "Mitigação de garantias individuais, antecipação da tutela penal para atos preparatórios e punição voltada à neutralização do agente perigoso.",
        "correta": true,
        "explicacao_especifica": "Características basilares do Direito Penal do Inimigo de Günther Jakobs."
      },
      {
        "letra": "C",
        "texto": "Descriminalização de condutas de bagatela e aplicação prioritária de penas alternativas.",
        "correta": false,
        "explicacao_especifica": "Característica do Direito Penal Mínimo / Minimalismo."
      },
      {
        "letra": "D",
        "texto": "Extinção das penas privativas de liberdade e substituição por monitoramento eletrônico amplo.",
        "correta": false,
        "explicacao_especifica": "Abolicionismo penal."
      },
      {
        "letra": "E",
        "texto": "Reforço da presunção de inocência e proibição do uso de medidas cautelares reais.",
        "correta": false,
        "explicacao_especifica": "Garantismo penal hiperbólico."
      }
    ]
  },
  {
    ...
    "alternativas": [
      {
        "texto": "Certo",
        "correta": true,
        "explicacao_especifica": "A prevenção situacional foca no desenho ambiental e medidas físicas de redução de oportunidades criminais."
      },
      {
        "texto": "Errado",
        "correta": false,
        "explicacao_especifica": "Incorreto. A descrição espelha fielmente as 25 técnicas de prevenção situacional de Clarke."
      }
    ]
  }
];
